...
<body>
<canvas id="gameField" width="2048" height="1024"></canvas>
<iframe id="jitsi" allow="camera; microphone" scrolling="no" src="<?php echo "https://meet.jit.si/coronajass".$_GET["id"];?>"></iframe>
